<div class="mb-5 card border-darker">
	<img src="{{ bust('/assets/img/commissions/figure1.png') }}" class="card-img-top">
	<div class="card-body text-white bg-darker">
		<h5 class="card-title">Character Illustrations</h5>
		<ul>
...
<div class="mb-5 card border-darker">
	<img src="{{ bust('/assets/img/commissions/figure2.png') }}" class="card-img-top">
	<div class="card-body text-white bg-darker">
...
<div class="mb-5 card border-darker">
	<img src="{{ bust('/assets/img/commissions/figure3.png') }}" class="card-img-top">
	<div class="card-body text-white bg-darker">
		<h5 class="card-title">Character Reference Sheets</h5>
		<ul>
...
<div class="mb-5 card border-darker">
	<img src="{{ bust('/assets/img/commissions/figure4.png') }}" class="card-img-top">
	<div class="card-body text-white bg-darker">
		<h5 class="card-title">Discord Emotes &amp; Telegram Stickers</h5>
		<ul>
